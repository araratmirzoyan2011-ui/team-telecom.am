export function border6(inf1, inf2, inf3, sizeClass, bgImage) {
  return (
    <>
      <div className={`flex justify-between rounded-[10px] text-white h-[300px] max-[1100px]:h-[200px] ${sizeClass}`}>

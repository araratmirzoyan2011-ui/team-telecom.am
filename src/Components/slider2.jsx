    ...
    <SwiperSlide key={i} className="flex justify-center">
      {i <= 17 ? (
        <div
          ...
          className="w-[90%] h-[500px] flex flex-col border border-gray-500 bg-[whitesmoke] rounded-[20px] overflow-hidden text-black cursor-pointer"
        >
          <img
            src={el.src}
        ...
        <div
          onClick={() => navigate(`/news/${el.id}`)}
          className="w-[90%] h-[500px] flex flex-col border border-gray-500 bg-[whitesmoke] rounded-[20px] p-[15px] box-border text-black cursor-pointer"
        >

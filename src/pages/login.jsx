          ...
          <div className="w-full ml-[10%] mt-[60px] max-w-md mx-auto bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            {mainTab === 'Business' && (
              <div className="text-smtext-center py-8">
                <h3 className="block text-xs font-medium text-black-500 mb-[20px] text-[24px]">Welcome to Team business account</h3>
                <div>
                    <label className="block text-xs font-medium text-gray-500 mb-1">
                      Password
                    </label>
                ...
                <div>
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 bg-[#e34234] hover:bg-[#d23528] text-white font-medium text-sm rounded-md transition-colors mt-[40px]"
                  >
                    Sign in
                  </button>

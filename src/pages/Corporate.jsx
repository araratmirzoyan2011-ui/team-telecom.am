...
function Corporate() {
    return (
       ...
       <div className="mt-[-50px] h-[120px] bg-neutral-100 flex justify-center items-center w-4/5 ml-[10%] max-[1200px]:w-[90%] max-[1200px]:ml-[5%] max-[900px]:w-[94%] max-[900px]:ml-[3%]">
            ...
            <HBorder2 url="https://www.telecomarmenia.am/files/icons/1/16511223989344/45x45.png" text="Corporate Network" />
            <HBorder url="https://www.telecomarmenia.am/files/icons/1/16511223989344/45x45.png" text="M2M and monitoring" />
        ...
        <div className="w-[80%] h-[500px] mt-[50px] ml-[10%] mb-[150px] grid grid-cols-3 gap-5 max-xl:grid-cols-3 max-[800px]:grid-cols-2 max-[800px]:h-[900px] max-[700px]:grid-cols-1">
            {hborder3("Corporate VPN","Private Network creating.")}
            {hborder3("Build-up of corporate network","Reliable data transmission infrastructure")}
            {hborder3("Mobile VPN","Manage your company's business at any time, anywhere in the country")}
            {hborder3("Mobile LAN","Organize data transfer on an IP server, without direct Internet access")}
        </div>
        <Footer />
        </>
    )

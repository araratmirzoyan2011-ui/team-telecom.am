...
function Services() {
    ...
    return (
        <>
            {header()}
            {bgimg("https://www.telecomarmenia.am/images/menu/1/17857571349765.png")}
            <div className="mt-[-50px] h-[120px] bg-white shadow-md rounded-lg flex justify-center items-center w-4/5 ml-[10%] max-[1200px]:w-[90%] max-[1200px]:ml-[5%] max-[900px]:w-[94%] max-[900px]:ml-[3%] z-10 relative">
                ...
                <HBorder2 url="https://www.telecomarmenia.am/files/icons/1/16511222028662/45x45.png" text="Services" onClickHandler={() => navigate('/services')} />
            </div>
            
            <h1 className="text-[40px] ml-[10%] font-bold text-[rgb(22,20,20)] mt-[60px] mb-[40px]">Roaming in Russia, Georgia</h1>
            ...
            <h1 className="text-[40px] ml-[10%] font-bold text-[rgb(22,20,20)] mt-[60px] mb-[40px]">INTERNET IN ROAMING IN 100 COUNTRIES</h1>

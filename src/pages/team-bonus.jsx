...
import { StepTimeline } from '../Components/StepTimeline'; // Ճշտիր ուղին ըստ քո պանակների
...
>
  <div className="max-w-7xl w-full mx-auto flex flex-col md:flex-row items-center justify-between gap-8 h-full py-10">
      ...
      <div className="w-full h-[500px] bg-[#024566] flex flex-col justify-around items-center text-white">

        <h1 className="text-[48px]">How to join?</h1>
        <StepTimeline />
      </div>
        <N3
